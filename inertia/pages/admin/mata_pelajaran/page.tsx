...
export default function DashboardAdminMataPelajaran({
  ...
  return (
    <AdminLayout>
      <div>
        <Head title="Mata Pelajaran - Panel Admin" />
        <Header title={'Mata Pelajaran'} back={false} refresh={true}>
          <Link
            href={routes.as['admin.matapelajaran.create']}
          ...
          <Dialog open={dialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Anda yakin ingin menghapus data Mata Pelajaran?</DialogTitle>
                <DialogDescription className="text-sm pt-4">
                  Pastikan Anda berhati-hati saat menghapus data mata pelajaran, karena perubahan
                  ini tidak dapat dibatalkan atau dipulihkan dengan mudah. Kami sangat menyarankan
                  Anda untuk memeriksa dengan cermat sebelum melanjutkan penghapusan, agar tidak
        ...
        <div className="p-6">
          <h1 className="text-18px leading-24 font-medium">Daftar Mata Pelajaran Yang Tersedia</h1>
          <div className="mt-2 flex flex-col gap-2">
            <p className="text-12px text-black/70">
              Aplikasi ini menyediakan daftar mata pelajaran yang dapat dipilih untuk mengikuti
              ujian online berbasis komputer (CBT).
            </p>
            <p className="text-12px text-black/70">
              Setiap mata pelajaran dilengkapi dengan soal-soal terkini dan terstruktur untuk
              membantu meningkatkan pemahaman serta persiapan Anda. Pilih mata pelajaran dan mulai
              ujian sesuai kebutuhan belajar Anda.
            </p>
          </div>
          <DataTableAdminMataPelajaran data={mataPelajaran} state={{ setIds: setData }} />
        </div>
      </div>
    </AdminLayout>
  )
